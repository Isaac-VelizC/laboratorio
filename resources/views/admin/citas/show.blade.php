        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-10 border">{{ isset($cita->client) ? $cita->client->user->nombres .' '. $cita->client->user->apellido_pa.' '. $cita->client->user->apellido_ma :"" }}</div>
                    <div class="col-md-1 border bg-primary text-light">Sexo</div>
                    <div class="col-md-3 border">{{ isset($cita->client) ? $cita->client->gender :"" }}</div>
                    <div class="col-md-1 border bg-primary text-light">Teléfono</div>
                    <div class="col-md-3 border">{{ isset($cita->client) ? $cita->client->contact :"" }}</div>
                    <div class="col-md-1 border bg-primary text-light">Correo</div>
                    <div class="col-md-3 border">{{ isset($cita->client) ? $cita->client->user->email :"" }}</div>
                    <div class="col-md-2 border bg-primary text-light">Dirección</div>
                    <div class="col-md-10 border">{{ isset($cita->client) ? $cita->client->address :"" }}</div>
                    <div class="col-md-2 border bg-primary text-light">Estado</div>
                    ...
                    <div class="col-md-2 border bg-primary text-light">Prescripción</div>
                    <div class="col-md-4 border ">
