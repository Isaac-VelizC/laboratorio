            ...
            <div class="col-4 col-md-6">
                <div class="float-start float-lg-end">
                    <a href="javascript:void(0)" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                        data-bs-backdrop="false" data-bs-target="#modal_create_pacientes">
                        Nuevo
                    </a>
                </div>
            </div>
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="">
                                <p class="m-0 truncate-1">{{ $item->user->nombres }} {{ $item->user->apellido_pa }} {{
                                    $item->user->apellido_ma }}</p>
                            </td>
                            <td class="">
                                <p class="m-0 truncate-1">{{ $item->user->ci }}</p>
                            </td>
                            <td class="">
                                <p class="m-0 truncate-1">{{ $item->user->email }}</p>
                            </td>
                            <td class="">
                                <p class="m-0 truncate-1">{{ $item->contact }}</p>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                                <div class="flex align-items-center">
                                    ...
                                    <a class="px-1" href="javascript:void(0)" onclick="confirmDelete({{ $item->id }})"
                                        data-bs-toggle="modal" data-bs-backdrop="false" data-bs-target="#modal-default">
                                        @if ($item->status == 0) <i class="bi bi-activity"></i> @else <i
                                            class="bi bi-trash"></i> @endif
                                    </a>
...
<div class="modal fade text-left" id="modal-confirmacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel4"
    aria-hidden="true">
